...
public class VelocityHUDFabric implements ClientModInitializer {

    private static VelocityHUDFabric instance;
    ...
    public void onInitializeClient() {
        ...
        this.hudRenderer = new FabricHUDRenderer(configManager);

        FabricKeybinds.register();

        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (FabricKeybinds.isTogglePressed()) {
    ...
    public static VelocityHUDFabric getInstance() {
        return instance;
    }
