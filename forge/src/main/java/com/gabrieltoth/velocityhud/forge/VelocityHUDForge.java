...
@Mod("velocityhud")
public class VelocityHUDForge {

    private static VelocityHUDForge instance;
    private ConfigManager configManager;
    private final VelocityTracker velocityTracker = new VelocityTracker();
    private ForgeHUDRenderer hudRenderer;

    public VelocityHUDForge() {
        instance = this;
    ...
    private void onClientSetup(FMLClientSetupEvent event) {
        ...
        this.hudRenderer = new ForgeHUDRenderer(configManager);
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (player != null && !client.isPaused()) {
            if (ForgeKeybinds.TOGGLE_HUD_KEY.consumeClick()) {
    ...
    public static VelocityHUDForge getInstance() {
        return instance;
    }
